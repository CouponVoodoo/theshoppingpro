...
echo("\n\n CHANGED \n\n");
db_query ("UPDATE coupon_finder_march2nd.Node INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.Node.entity_id SET coupon_finder_march2nd.Node.changed = ".time()." WHERE coupon_finder_march2nd.Node.entity_id = 173951 ");

echo("\n\n TITLE \n\n");
db_query ("UPDATE coupon_finder_march2nd.Node INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.Node.entity_id SET coupon_finder_march2nd.Node.title = coupon_finder_march2nd.predictorCompiledResultTable.pagetitle WHERE coupon_finder_march2nd.Node.entity_id = 173951 ");

echo("\n\n CHANGED - REVISION \n\n");
db_query ("UPDATE coupon_finder_march2nd.node_revision INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.node_revision.entity_id SET coupon_finder_march2nd.node_revision.changed = ".time()."WHERE coupon_finder_march2nd.node_revision.entity_id = 173951 ");

echo("\n\n TITLE - REVISION \n\n");
db_query ("UPDATE coupon_finder_march2nd.node_revision INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.node_revision.entity_id SET coupon_finder_march2nd.node_revision.title = coupon_finder_march2nd.predictorCompiledResultTable.pagetitle WHERE coupon_finder_march2nd.node_revision.entity_id = 173951 ");
...
db_query ("UPDATE coupon_finder_march2nd.field_data_field_product_popularity INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.field_data_field_product_popularity.entity_id SET coupon_finder_march2nd.field_data_field_product_popularity.field_best_coupon_status_value = coupon_finder_march2nd.predictorCompiledResultTable.BestCouponStatus WHERE coupon_finder_march2nd.field_data_field_product_popularity.entity_id = 173951 ");

echo("\n\n FIELD_BEST_COUPON_STATUS_VALUE  - REVISION \n\n");
db_query ("UPDATE coupon_finder_march2nd.field_revision_field_product_popularity INNER JOIN coupon_finder_march2nd.predictorCompiledResultTable ON coupon_finder_march2nd.predictorCompiledResultTable.entity_id = coupon_finder_march2nd.field_revision_field_product_popularity.entity_id SET coupon_finder_march2nd.field_revision_field_product_popularity.field_best_coupon_status_value = coupon_finder_march2nd.predictorCompiledResultTable.BestCouponStatus WHERE coupon_finder_march2nd.field_revision_field_product_popularity.entity_id = 173951 ");
