...
if ($row->Successful=="1") {
  ...
  $best_coupon = !empty($row->BestCoupon) ? '<span class="best_coupon">Best Coupon</span>' : '<span class="best_coupon_image"><img src="'.$image_right.'"  width="100%" /> </span> <div class="guaranteed_pro">Coupons Found</div>';
}else {
