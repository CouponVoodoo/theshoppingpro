...
<div class="search_listing_right">
  <div class="search_listing_row__<?php print $row->counter; ?> copy_coupon_row">
    <?php if ($row->url): ?>
    <a href="<?php print $base_url ?>/coupon-redirect?s=<?php print urlencode($row->url); ?>" target="_blank" class="unlock_coupon unlock_coupon_<?php print $row->counter; ?>" rel="best_<?php print $row->counter; ?>">
