...
global $base_url;
print "<div class='user_image_section'>" . "<img width='80' height='60' typeof='foaf:Image' src='" . $base_url . "/sites/default/files/" . $entity_uri['field_first_name']['#object']->field_image['und'][0]['filename']."'/>" . "</div>";
?>
