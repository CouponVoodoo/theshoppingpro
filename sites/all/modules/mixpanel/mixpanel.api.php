...
/**
 * Alter the default properties that are sent to Mixpanel with every event for
 * the given user.
 *
...
function hook_mixpanel_people_defaults_alter(&$data, $account) {
  // Adds a 'user_name' property to the 'People data' sent to Mixpanel for a given user.
  $properties['user_name'] = $account->name;
}
