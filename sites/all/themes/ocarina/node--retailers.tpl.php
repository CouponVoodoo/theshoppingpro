...
<div class="block-inner clearfix">
	...
	print "<a href='".$corp_landing_url."' class=".$class."><h2>".$term_record[0][0]->name."</h2>".strip_tags($maincategory_desc)."</a>"; 			
		...
		//$corp_landing_url=get_corp_url($landing_url,$redirect,$url_part_1,$url_part_2,$affiliate_id);
	    $corp_landing_url=getcashbackurl(strip_tags(render($content['field_url'])),$landing_url);
		print "<ul class='first-level'><li><a href='".print $corp_landing_url."' class=".print $class.">".$child_term[1]->name."<p>".strip_tags($maincategory_desc)."</p></a>"; 			
		...
		//$corp_landing_url=get_corp_url($landing_url,$redirect,$url_part_1,$url_part_2,$affiliate_id);
		$corp_landing_url=getcashbackurl(strip_tags(render($content['field_url'])),$landing_url);
		print "<ul class='second-level'><li><a href='".print $corp_landing_url."' class=".print $class.">".$child_term[2]->name."<p>".strip_tags($maincategory_desc)."</p></a>"; 		
		...
		print "<ul class='third-level'><li><a href='".print $corp_landing_url."' class=".print $class."><a>".$child_term[3]->name."<p>".strip_tags($maincategory_desc)."</p></a>";		
